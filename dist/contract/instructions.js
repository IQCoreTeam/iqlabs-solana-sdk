...
const createInstructionBuilder = (idl = exports.IQ_IDL, programId = profile_1.PROGRAM_ID) => {
...
const updateDbRootGlobalTableListInstruction = (builder, accounts, args) => builder.build("update_db_root_global_table_list", accounts, args);
exports.updateDbRootGlobalTableListInstruction = updateDbRootGlobalTableListInstruction;
