...
export declare const CODE_IN_INSTRUCTION_NAMES: readonly ["user_inventory_code_in", "user_inventory_code_in_for_free", "db_code_in", "db_instruction_code_in", "wallet_connection_code_in"];
...
export declare const decodeUserInventoryCodeIn: (tx: VersionedTransactionResponse) => {
    onChainPath: string;
    metadata: string;
};
export declare const extractCodeInPayload: (tx: VersionedTransactionResponse) => {
    onChainPath: string;
    metadata: string;
...
export declare function getSessionPdaList(userPubkey: string): Promise<string[]>;
